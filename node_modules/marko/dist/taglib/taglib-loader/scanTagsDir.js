...
const searchFiles = [{ name: "index.marko", type: "template" }, { name: "renderer", type: "renderer" }, { name: "index", type: "renderer" }, { name: "template.marko", type: "template" }, { name: "template.html", type: "template" }, { name: "code-generator", type: "code-generator" }, { name: "node-factory", type: "node-factory" }, { name: "transformer", type: "transformer" }];
